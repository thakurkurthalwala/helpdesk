...
// --> General settings
$hesk_settings['site_title']='OIFTech_Desk';
$hesk_settings['site_url']='http://localhost';
$hesk_settings['hesk_title']='Insure@Oasis';
$hesk_settings['hesk_url']='http://localhost/helpdeskticket';
...
$hesk_settings['db_user']='hesk-owner';
$hesk_settings['db_pass']='hesk123$%';
$hesk_settings['db_pfix']='hesk';
...
$hesk_settings['question_ask']='Which number is higher <b>3</b> or <b>6</b>:';
$hesk_settings['question_ans']='6';
...
$hesk_settings['url_key']='TUpJ6ps-cEek5XwAQmgHeFk5krGb0p';
...
$hesk_settings['noreply_name']='OIF HELP Desk';
...
$hesk_settings['ticket_list']=array('id','trackid','dt','lastchange','name','email','subject','status','owner','replies','staffreplies','lastreplier','time_worked');
